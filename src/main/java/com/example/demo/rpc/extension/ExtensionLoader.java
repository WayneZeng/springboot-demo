 ...
 */
package com.example.demo.rpc.extension;

import com.example.demo.rpc.common.URL;
import com.example.demo.rpc.context.dubbocontext.Lifecycle;
import com.example.demo.rpc.context.dubbocontext.SPI;
import com.example.demo.rpc.utils.ConcurrentHashSet;
import com.example.demo.rpc.utils.ConfigUtils;
import com.example.demo.rpc.utils.Prioritized;
...
import static com.example.demo.rpc.constants.CommonConstants.*;
import static java.util.Collections.sort;

/**
 *
 * {@code DubboBootstrap} and this class are
...
public class ExtensionLoader<T> {
    ...
    private ExtensionLoader(Class<?> type) {
        this.type = type;
        objectFactory = (type == ExtensionFactory.class ? null : null);
    }
    ...
    public static void destroyAll() {
        EXTENSION_INSTANCES.forEach((_type, instance) -> {
            if (instance instanceof com.example.demo.rpc.context.dubbocontext.Lifecycle) {
                com.example.demo.rpc.context.dubbocontext.Lifecycle lifecycle = (com.example.demo.rpc.context.dubbocontext.Lifecycle) instance;
                try {
                    lifecycle.destroy();
                } catch (Exception e) {
...
//    }
    ...
    public T getDefaultExtension() {
        getExtensionClasses();
        if (isBlank(cachedDefaultName) || "true".equals(cachedDefaultName)) {
            return null;
        }
    ...
    public Set<T> getSupportedExtensionInstances() {
        ...
        if (!isEmpty(supportedExtensions)) {
