...
import com.example.demo.rpc.constants.RemotingConstants;
import com.example.demo.rpc.utils.CollectionUtils;
...
class URL implements Serializable {
    ...
    public boolean isLocalHost() {
        return "localhost".equals(host) || getParameter(LOCALHOST_KEY, false);
    }
    ...
    private void buildParameters(StringBuilder buf, boolean concat, String[] parameters) {
        if (CollectionUtils.isNotEmptyMap(getParameters())) {
            List<String> includes = (null == parameters ? null : Arrays.asList(parameters));
            boolean first = true;
